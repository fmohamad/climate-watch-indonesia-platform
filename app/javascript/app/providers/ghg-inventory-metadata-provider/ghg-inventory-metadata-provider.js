...
import reducers, { initialState } from './ghg-inventory-metadata-provider-reducers';
...
MetaProvider.propTypes = {
  params: PropTypes.oneOfType([ PropTypes.string, PropTypes.array, PropTypes.object ]).isRequired,
