ActiveAdmin.register_page 'Indonesia Platform West Papua Policies' do
  include DataUploader::SharedAdmin

  section_name = 'west_papua_policies'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}west_papua_policies"
    end

    def path
      admin_indonesia_platform_west_papua_policies_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'WestPapua::ImportPolicies', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_west_papua_policies_upload_datafile_path,
      download_path: admin_indonesia_platform_west_papua_policies_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_west_papua_policies_download_datafile_path,
      import_path: admin_indonesia_platform_west_papua_policies_run_importer_path,
