ActiveAdmin.register_page 'Indonesia Platform Emission Projections' do
  include DataUploader::SharedAdmin

  section_name = 'emission_projections'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}emission_projections"
    end

    def path
      admin_indonesia_platform_emission_projections_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportEmissionProjections', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_emission_projections_upload_datafile_path,
      download_path: admin_indonesia_platform_emission_projections_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_emission_projections_download_datafile_path,
      import_path: admin_indonesia_platform_emission_projections_run_importer_path,
